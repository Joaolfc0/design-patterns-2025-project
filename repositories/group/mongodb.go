...
func (r *resource) CreateGroup(group *models.Group) (*models.Group, *customError.CustomError) {
	...
	if err != nil {
		return nil, customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Failed to create group"))
	}
...
func (r *resource) GetGroupByID(id string) (*models.Group, *customError.CustomError) {
	...
	if err != nil {
		return nil, customError.CustomErrorFactory(customError.WithBadRequest("Invalid group ID", "Invalid ID format"))
	}
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			return nil, customError.CustomErrorFactory(customError.WithNotFound("Group not found", "No group found with the given ID"))
		}
		return nil, customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Error finding group"))
	}

	// Rebuild Observers after loading from DB
	group.RebuildObservers()
...
func (r *resource) UpdateGroup(id string, group *models.Group) (*models.Group, *customError.CustomError) {
	...
	if err != nil {
		return nil, customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Failed to update group"))
	}
...
func (r *resource) DeleteGroup(id string) *customError.CustomError {
	...
	objectID, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return customError.CustomErrorFactory(customError.WithBadRequest("Invalid group ID", "Invalid ID format"))
	}

	_, err = collection.DeleteOne(context.Background(), bson.M{"_id": objectID})
	if err != nil {
		return customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Failed to delete group"))
	}
...
func (r *resource) AddParticipant(id string, participant *models.Participant) (*models.Group, *customError.CustomError) {
	...
	if err != nil {
		return nil, customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Failed to add participant"))
	}
...
func (r *resource) UpdateMatches(id string, matches []models.Match) *customError.CustomError {
	...
	_, err = collection.UpdateOne(context.Background(), bson.M{"_id": objectID}, update)
	if err != nil {
		return customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Failed to update matches"))
	}
...
func (r *resource) GetMyMatch(id string, username string) (string, *customError.CustomError) {
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			return "", customError.CustomErrorFactory(customError.WithNotFound("Group not found", "No group found with the given ID"))
		}
		return "", customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Error finding group"))
	}
	...
	return "", customError.CustomErrorFactory(customError.WithNotFound("Match not found", "No match found for the given username"))
}
...
func (r *resource) GetAllGroups() ([]*models.Group, *customError.CustomError) {
	...
	if err != nil {
		return nil, customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Error retrieving groups"))
	}
	defer cursor.Close(context.Background())

	var groups []*models.Group
	if err = cursor.All(context.Background(), &groups); err != nil {
		return nil, customError.CustomErrorFactory(customError.WithInternalServerError(err.Error(), "Error decoding groups"))
	}
