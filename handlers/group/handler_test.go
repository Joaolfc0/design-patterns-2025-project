...
func internalErrorExample() *customError.CustomError {
	return customError.CustomErrorFactory(customError.WithInternalServerError("???", "generic service error"))
}
...
func TestGetGroup_NotFound(t *testing.T) {
	...
	err := customError.CustomErrorFactory(customError.WithNotFound("Group not found", "Not found"))
	mockCtrl, mockServices := setupTest(t)
	defer mockCtrl.Finish()
